...
# network g settings
network_g:
  # Architecture type. Usually the class name defined in the `basicsr_lite/archs` folder
  type: MSRResNet
  #### The following arguments are flexible and can be obtained in the corresponding doc
...
train:
  ...
  pixel_opt:
    # Loss type. Usually the class name defined in the `basicsr_lite/models/losses` folder
    type: L1Loss
    # Loss weight
    loss_weight: 1.0
    # Loss reduction mode
...
val:
  ...
  metrics:
    ...
    psnr:
      # Metric type. Usually the function name defined in the`basicsr_lite/metrics` folder
      type: calculate_psnr
      #### The following arguments are flexible and can be obtained in the corresponding doc
...
logger:
  ...
  wandb:
    ...
    # Here, we use the basicsr_lite wandb project: https://app.wandb.ai/xintao/basicsr_lite
    project: basicsr_lite
