...
from basicsr_lite.data.degradations import add_jpg_compression
from basicsr_lite.data.transforms import augment, mod_crop, paired_random_crop
from basicsr_lite.utils import FileClient, imfrombytes, img2tensor, scandir
...
class ExampleDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        # https://github.com/xinntao/BasicSR/blob/master/basicsr_lite/data/
