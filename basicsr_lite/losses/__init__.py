...
from basicsr_lite.utils.registry import LOSS_REGISTRY
...
_model_modules = [importlib.import_module(f'basicsr_lite.losses.{file_name}') for file_name in loss_filenames]
